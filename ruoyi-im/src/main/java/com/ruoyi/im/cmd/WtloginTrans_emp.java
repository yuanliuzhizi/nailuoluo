...
public class WtloginTrans_emp {
    ...
    public byte[] part2Core(byte[] share_key, User u, Android android, App app) {//key  79 87 8B 45 4A B0 1B CF A1 E5 44 39 81 6F EE 2E
        pack.empty();
...
//            pack.setHex("00 01 11 00 00 00 10 00 00 00 72 00 00 00
//            63 15 C2 F1
//            02 01 0D 00 31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 00 32 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 10 00 00 00 00 00 00 00 00 08 00 00 00 06
//            00 16 00 49 00 00 00 05 00 00 00 10
//            20 02 FC 74
//            4B C7 A2 8B E7 DC 7C 89 9A 65 94 F8 A6 30 F8 4B
//            00 12
//            63 6F 6D 2E 74 65 6E 63 65 6E 74 2E 71 71 6C 69 74 65
//            00 05
//            32 2E 31 2E 32
//            00 10
//            A6 B7 45 BF 24 A2 C2 77 52 77 16 F6 F3 6E B6 8D 00 1B
//            00 1E 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 48 00 00 00 02 00 00 00 02 00 00 00 1D 00 0E 01 00 F7 FF 7C 00 00 00 00 00 00 00 00 00 00 1F 00 2D 01 00 07 61 6E 64 72 6F 69 64 00 05 35 2E 31 2E 31 00 02 00 10 43 68 69 6E 61 20 4D 6F 62 69 6C 65 20 47 53 4D 00 00 00 04 77 69 66 69 00 33 00 10 4B C7 A2 8B E7 DC 7C 89 9A 65 94 F8 A6 30 F8 4B 00 35 00 04 00 00 00 00 03");

        pack.setHex("00 01 11 00 00 00 10 00 00 00 72 00 00 00");
        pack.setBin(u.toTimeByte());
        pack.setHex("02 01 0D 00 31 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 00 00 00 32 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 10 00 00 00 00 00 00 00 00 08 00 00 00 06");
        pack.setHex("00 16 00 49 00 00 00 05 00 00 00 10");
        pack.setBin(AllToByte.intToByte(app.getAppid1()));
        pack.setHex("4B C7 A2 8B E7 DC 7C 89 9A 65 94 F8 A6 30 F8 4B");
        pack.setHex("00 12 63 6F 6D 2E 74 65 6E 63 65 6E 74 2E 71 71 6C 69 74 65");
        pack.setHex("00 05 32 2E 31 2E 32");
//            pack.setHex("00 10 A6 B7 45 BF 24 A2 C2 77 52 77 16 F6 F3 6E B6 8D 00 1B");
//            pack.setHex("00 1E 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 48 00 00 00 02 00 00 00 02 00 00 00 1D 00 0E 01 00 F7 FF 7C 00 00 00 00 00 00 00 00 00 00 1F 00 2D 01 00 07 61 6E 64 72 6F 69 64 00 05 35 2E 31 2E 31 00 02 00 10 43 68 69 6E 61 20 4D 6F 62 69 6C 65 20 47 53 4D 00 00 00 04 77 69 66 69 00 33");
        pack.setHex("00 10 A6 B7 45 BF 24 A2 C2 77 52 77 16 F6 F3 6E B6 8D");
        pack.setHex("00 1B 00 1E 00 00 00 00 00 00 00 00 00 00 00 08 00 00 00 04 00 00 00 48 00 00 00 02 00 00 00 02 00 00 00 1D 00 0E 01 00 F7 FF 7C 00 00 00 00 00 00 00 00 00 00 1F 00 2D 01 00 07 61 6E 64 72 6F 69 64 00 05 35 2E 31 2E 31 00 02 00 10 43 68 69 6E 61 20 4D 6F 62 69 6C 65 20 47 53 4D 00 00 00 04 77 69 66 69 00 33");
        pack.setShort((short) AllToByte.hexToByte(android.getGuid()).length);
        pack.setHex(android.getGuid());
//        pack.setHex("00 35 00 04 00 00 00 73 03");
        //0QQ 3IPad 5Mac 13 Linux 17PC 73手表
        pack.setHex("00 35 00 04 00 00 00 00 03");

        return teaService.encrypt(pack.getAll(), share_key);
    }
    ...
    public byte[] outer(byte[] part1Outer, byte[] part2Outer, byte[] hexTextUser) {
        ...
        byte[] bin = teaService.encrypt(pack.getAll(), new byte[16]);
        pack.empty();
    ...
    public byte[] wtloginTrans_emp(Map initUser) {
        ...
        try {
            ...
            byte[] part2Core = wtloginTrans_emp.part2Core(AllToByte.hexToByte(ecdh.getShare_key()), u, android, app);
...
//00 00 00 38 00 02 00 38 00 12 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 03 [四字节递增] 00 00 00 26 00 00 00 00 00 00 00 00 00 05 01 00 00 00 75 00 00 00 10 [30没有扫码35扫码了] 03 //扫码了
     ...
     * @return int值
     */
    public List unPackState(byte[] data, Map initUser) {
     ...
     * @return int值
     */
    public List unPack(byte[] data, Map initUser) {
        List list = new ArrayList();
        Ecdh ecdh = (Ecdh) initUser.get("ecdh");
        UnPack unPack = new UnPack();
        unPack.setData(data);
